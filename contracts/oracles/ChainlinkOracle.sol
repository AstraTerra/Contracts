 ...
 * @notice Contract in charge or reading the information from a Chainlink Oracle. HMKT contracts read the price directly from this contract. More information can be found on Chainlink Documentation
 */
